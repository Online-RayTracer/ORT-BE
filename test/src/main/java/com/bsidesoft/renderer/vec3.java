...
public class vec3 {
    ...
    public vec3(float x1, float y1, float z1) { x = x1; y = y1; z = z1; }
    ...
    public vec3 diff(vec3 o) { vec3 v = new vec3(this); v.sub(o); return v; }
    ...
    public float size() { return (float)Math.sqrt(size_sqr()); }
